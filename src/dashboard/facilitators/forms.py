    ...
    def __init__(self, *args, **kwargs):
        ...
        for doc in administrativelevels_docs:
            ...
            if doc.get("type") == "administrative_level":
                ...
                elif doc.get("administrative_level") == "Cercle":
                    query_result_cercles.append(doc)
        ...
        self.fields["cercle"].widget.choices = get_choices(
            query_result_cercles, "administrative_id", "name"
        )
