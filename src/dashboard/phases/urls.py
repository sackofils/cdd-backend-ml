...
urlpatterns = [
    ...
    path('phases-list/<int:id>', views.PhaseListTableView.as_view(), name='phases_list'),
    path('create/<int:id>', views.CreatePhaseFormView.as_view(), name='create'),
    path('<int:project_id>/<int:pk>/update/', views.UpdatePhaseView.as_view(), name='update'),
